...
CREATE TABLE PEDIDO (_ID INTEGER PRIMARY KEY AUTOINCREMENT, ID_USUARIO INTEGER NOT NULL, ID_PRESTADOR INTEGER NOT NULL, FECHA TEXT NOT NULL, ID_SERVICIO INTEGER NOT NULL, ID_UBICACION INTEGER NOT NULL, CONFIRMADO INTEGER NOT NULL DEFAULT 0);
...
INSERT INTO USUARIO (_ID,USERNAME,PASS,NOMBRE,CELULAR,DNI,IMAGEN,ID_ROL,ID_SERVICIO,ID_UBICACION) VALUES (3,'prestador1@gmail.com','prestador1','Super Grúa','+543421535565','30000000','img1',2,3,3);
INSERT INTO USUARIO (_ID,USERNAME,PASS,NOMBRE,CELULAR,DNI,IMAGEN,ID_ROL,ID_SERVICIO,ID_UBICACION) VALUES (4,'prestador2@gmail.com','prestador2','Emergencias Médicas Santa Fe','+543424533','25000000','img2',2,4,4);
INSERT INTO USUARIO (_ID,USERNAME,PASS,NOMBRE,CELULAR,DNI,IMAGEN,ID_ROL,ID_SERVICIO,ID_UBICACION) VALUES (5,'prestador3@gmail.com','prestador3','Grúa Express','+543421407325','30000000','img3',2,5,5);
INSERT INTO USUARIO (_ID,USERNAME,PASS,NOMBRE,CELULAR,DNI,IMAGEN,ID_ROL,ID_SERVICIO,ID_UBICACION) VALUES (6,'prestador4@gmail.com','prestador4','Grúas Santa Fe','+543429876513','32000000','img4',2,6,6);
INSERT INTO USUARIO (_ID,USERNAME,PASS,NOMBRE,CELULAR,DNI,IMAGEN,ID_ROL,ID_SERVICIO,ID_UBICACION) VALUES (7,'prestador5@gmail.com','prestador5','RapiGrúa','+543424653561','34000000','img5',2,7,7);
INSERT INTO USUARIO (_ID,USERNAME,PASS,NOMBRE,CELULAR,DNI,IMAGEN,ID_ROL,ID_SERVICIO,ID_UBICACION) VALUES (8,'prestador5@gmail.com','prestador5','Doctor YA','+543421557751','28000000','img6',2,8,8);
INSERT INTO PEDIDO (_ID,ID_USUARIO,ID_PRESTADOR,FECHA,ID_SERVICIO,ID_UBICACION) VALUES (0,1,6,'8 de Marzo',6,1);
INSERT INTO PEDIDO (_ID,ID_USUARIO,ID_PRESTADOR,FECHA,ID_SERVICIO,ID_UBICACION) VALUES (1,1,7,'9 de Marzo',7,1);
INSERT INTO PEDIDO (_ID,ID_USUARIO,ID_PRESTADOR,FECHA,ID_SERVICIO,ID_UBICACION) VALUES (2,2,6,'8 de Marzo',6,2);
INSERT INTO PEDIDO (_ID,ID_USUARIO,ID_PRESTADOR,FECHA,ID_SERVICIO,ID_UBICACION) VALUES (3,2,7,'9 de Marzo',7,2);